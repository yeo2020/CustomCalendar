...
//        holder.layout.itemMonthText.text = "${calendar.get(Calendar.YEAR)}년 ${calendar.get(Calendar.MONTH) + 1}월"
        val tv = holder.layout.findViewById<TextView>(R.id.itemMonthText)
        tv.text = "${calendar.get(Calendar.YEAR)}년 ${calendar.get(Calendar.MONTH) + 1}월"
...
//        }
        ...
        val rv = holder.layout.findViewById<RecyclerView>(R.id.itemMonthDayList)
