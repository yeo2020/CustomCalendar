...
//        calendar.add(Calendar.DAY_OF_MONTH, (1-calendar.get(Calendar.DAY_OF_WEEK)) )
        ...
        tv3.text = calendar.time.time.toString()
        txt.text = "${tempYear.toString()}년"
        ...
        holder.layout.setOnClickListener {
            MyApp.preferences.setLong("selected_date",tv3.text.toString().toLong())
...
//            notifyItemChanged(position)
    ...
    override fun onViewRecycled(holder: ListAdapter) {
        ...
        txt.text = "${calendar.get(Calendar.YEAR).toString()}년"
    }
